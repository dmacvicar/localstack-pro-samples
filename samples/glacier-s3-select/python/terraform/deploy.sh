...
# Glacier S3 Select Terraform deployment script
...
echo "Deploying Glacier S3 Select with Terraform..."
...
RESULTS_BUCKET=$(tflocal output -raw results_bucket)
VAULT_NAME=$(tflocal output -raw vault_name)

# Upload archive to Glacier (Terraform can't do this directly)
